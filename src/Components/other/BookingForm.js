...
const BookingForm = ({ open, handleClose, selectedRoom }) => {
  ...
  const validateForm = () => {
    ...
    if (!formData.whatsapp || !phonePattern.test(formData.whatsapp)) {
      formErrors.whatsapp = "Please enter a valid 10-digit WhatsApp number.";
    }
      ...
      <Dialog open={open} onClose={handleClose} fullWidth maxWidth="xs">
        ...
        <DialogContent>
          <Typography variant="body1" gutterBottom sx={{ color: "#555" }}>
            Please provide your information below to complete the booking.
          </Typography>
      ...
      >
        <DialogContent sx={{ textAlign: "center", p: 4 }}>
          ...
          <Typography variant="body2" color="textSecondary" sx={{ mb: 3 }}>
            Our team will review your request and will get in touch with you
            soon via phone, WhatsApp, or email.
          </Typography>
          <Typography variant="h6" sx={{ color: "#555", mb: 1 }}>
            Booking Details:
          </Typography>
          <Typography variant="body2" sx={{ color: "#555" }}>
            <strong>Room Type:</strong> {selectedRoom?.title}
          </Typography>
          <Typography variant="body2" sx={{ color: "#555" }}>
